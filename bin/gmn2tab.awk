...
function getTire(line) {
	...
	line = gensub( /(b#0[^ ,]*)/, "\\\\lyrics<\"4\", dy=$Ty> (\\1)", "g", line);
	line = gensub( /(b#1[^ ,]*)/, "\\\\lyrics<\"8\", dy=$Ty> (\\1)", "g", line);
	line = gensub( /(b#2[^ ,]*)/, "\\\\lyrics<\"12\", dy=$Ty> (\\1)", "g", line);
	...
	line = gensub( /(f##1[^ ,]*)/, "\\\\lyrics<\"3''\", dy=$Ty> (\\1)", "g", line);
	line = gensub( /(f##2[^ ,]*)/, "\\\\lyrics<\"7''\", dy=$Ty> (\\1)", "g", line);
	return line;	
}
...
function getPousse(line) {
	...
	line = gensub( /(c&1[^ ,]*)/, "\\\\lyrics<\"4\", dy=$Py> (\\1)", "g", line);
	...
	line = gensub( /(b#0[^ ,]*)/, "\\\\lyrics<\"3'\", dy=$Py> (\\1)", "g", line);
	line = gensub( /(b#1[^ ,]*)/, "\\\\lyrics<\"6'\", dy=$Py> (\\1)", "g", line);
	line = gensub( /(b#2[^ ,]*)/, "\\\\lyrics<\"9'\", dy=$Py> (\\1)", "g", line);
...
function getPousseC(line) {
	...
	line = gensub( /(f##1[^ ,]*)/, "\\\\lyrics<\"5'\", dy=$Py> (\\1)", "g", line);
	line = gensub( /(f##2[^ ,]*)/, "\\\\lyrics<\"8'\", dy=$Py> (\\1)", "g", line);
	return line;	
}
...
function getPousseG(line) {
	...
	line = gensub( /(f##1[^ ,]*)/, "\\\\lyrics<\"6\", dy=$Py> (\\1)", "g", line);
	line = gensub( /(f##2[^ ,]*)/, "\\\\lyrics<\"9\", dy=$Py> (\\1)", "g", line);
	return line;	
}
...
function getPousseU(line) {
	...
	line = gensub( /(f##1[^ ,]*)/, "\\\\lyrics<\"5':6\", dy=$Py> (\\1)", "g", line);
	line = gensub( /(f##2[^ ,]*)/, "\\\\lyrics<\"8':9\", dy=$Py> (\\1)", "g", line);
	return line;	
}
...
function getNonAmbigu(line) {
	...
	line = gensub( /(e#1[^ ,]*)/, "\\\\lyrics<\"4'\", dy=$Ty> (\\1)", "g", line);
	line = gensub( /(e#2[^ ,]*)/, "\\\\lyrics<\"8'\", dy=$Ty> (\\1)", "g", line);
	...
	line = gensub( /(f##3[^ ,]*)/, "\\\\lyrics<\"12\", dy=$Py> (\\1)", "g", line);
	return line;	
}
...
function getAmbigu(line) {
	...
	line = gensub( /(c&1[^ ,]*)/, "\\\\lyrics<\"P4|T2'\", dy=$Ly> (\\1)", "g", line);
	...
	line = gensub( /(b#0[^ ,]*)/, "\\\\lyrics<\"P3'|T4\", dy=$Ly> (\\1)", "g", line);
	line = gensub( /(b#1[^ ,]*)/, "\\\\lyrics<\"P6'|T8\", dy=$Ly> (\\1)", "g", line);
	line = gensub( /(b#2[^ ,]*)/, "\\\\lyrics<\"P9'|T12\", dy=$Ly> (\\1)", "g", line);
	...
	line = gensub( /(f##1[^ ,]*)/, "\\\\lyrics<\"P5'|P6|T3''\", dy=$Ly> (\\1)", "g", line);
	line = gensub( /(f##2[^ ,]*)/, "\\\\lyrics<\"P8'|P9|T7''\", dy=$Ly> (\\1)", "g", line);
	return line;	
}
